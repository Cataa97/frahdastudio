...
<div class="container">
    <main id="content" role="main" class="middle-align">
        <header>
            <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','feminine-shop'), esc_html( get_search_query() ) ); ?></h1> 
        </header>
        <?php
            $feminine_shop_theme_lay = get_theme_mod( 'feminine_shop_theme_options','Right Sidebar');
            if($feminine_shop_theme_lay == 'Left Sidebar'){ ?>
                <div class="row">
                    <div class="col-lg-4 col-md-4" id="sidebar"><?php get_sidebar();?></div>
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        <?php if( get_theme_mod( 'feminine_shop_blog_post_pagination_position','bottom') == 'top' || get_theme_mod( 'feminine_shop_blog_post_pagination_position','bottom') == 'both') { ?>
                            <?php if( get_theme_mod( 'feminine_shop_blog_pagination_hide_show',true) == 1) { ?>
                              <div class="navigation">
                                <?php feminine_shop_blog_posts_pagination(); ?>
                        ...
                        ?>
                        <?php if( get_theme_mod( 'feminine_shop_blog_post_pagination_position','bottom') == 'bottom' || get_theme_mod( 'feminine_shop_blog_post_pagination_position','bottom') == 'both') { ?>
                            <?php if( get_theme_mod( 'feminine_shop_blog_pagination_hide_show',true) == 1) { ?>
                              <div class="navigation">
                                <?php feminine_shop_blog_posts_pagination(); ?>
                                  <div class="clearfix"></div>
