...
if ( ! class_exists( 'Feminine_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Feminine_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'feminine_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function feminine_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Feminine_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'feminine_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function feminine_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Feminine_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
