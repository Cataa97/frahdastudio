jQuery(document).ready(function($) {
    'use strict';
    var this_obj = feminine_shop_plugin_activate_plugin;


    $(document).on('click', '.feminine-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message feminine-shop-plugin-install');
                button.addClass('button-primary feminine-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.feminine-shop-recommended-plugins .feminine-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.feminine-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .feminine-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .feminine-shop-recommended-plugins').css('display','none');
    });
