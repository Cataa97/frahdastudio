...
function blossom_floral_admin_notice(){
    ...
    $dismissnonce    = wp_create_nonce( 'blossom_floral_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=blossom-floral-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the dashboard.', 'blossom-floral' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?blossom_floral_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>""><?php esc_html_e( 'Dismiss', 'blossom-floral' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function blossom_floral_update_admin_notice(){
    ...
    if ( ( isset( $_GET['blossom_floral_admin_notice'] ) && $_GET['blossom_floral_admin_notice'] = '1' ) && wp_verify_nonce( $_GET['_wpnonce'], 'blossom_floral_admin_notice' ) ) {
