...
if (!function_exists('blossom_floral_instagram')) :
    ...
    function blossom_floral_instagram($show = true) {
        ...
        if( $ed_instagram && $show ) {
            if( $ed_header ) {
                echo '<div class="instagram-section header-instagram">' . do_shortcode( $insta_code ) . '</div>';
            }
        }
        elseif( $ed_instagram && !$show ){
            if( $ed_footer ) echo '<div class="instagram-section footer-instagram">' . do_shortcode( $insta_code ) . '</div>';
        }
    }
endif;
